page 50809 "API Posted WSI_TS_Entry LineSO"
{
    PageType = API;
    ...
    EntityCaption = 'Posted WSI Time Entries Line';
    EntitySetCaption = 'Posted WSI Time Entries Lines';
    EntityName = 'postedwsi_ts_entryline';
    EntitySetName = 'postedwsi_ts_entrylines';

page 50718 "API Closed Sales_Leads HeaderS"
{
    PageType = API;
    ...
    EntityCaption = 'Closed Sales Propects Header';
    EntitySetCaption = 'Closed Sales Propects Headers';
    EntityName = 'closedsales_leadsheader';
    EntitySetName = 'closedsales_leadsheaders';
